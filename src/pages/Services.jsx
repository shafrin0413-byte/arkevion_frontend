...
const services = [
  { Icon: Code2,         slug: 'web-development',    title: 'Website Development',   body: 'Responsive business websites, landing pages, and portals built for speed, SEO, accessibility, and conversion.',          color: '#0d9488', image: '/New folder/dg.png' },
  { Icon: Layers,        slug: 'full-stack',          title: 'Full Stack Development', body: 'Complete web applications with React interfaces, secure APIs, databases, admin workflows, and deployment support.',     color: '#0891b2', image: '/New folder/modern.png' },
  ...
  { Icon: Palette,       slug: 'ui-ux',               title: 'UI/UX Design',          body: 'User journeys, wireframes, prototypes, and clean design systems that make digital products easier to understand.',       color: '#7c3aed', image: '/New folder/UI.png' },
...
// Services that have a dedicated landing page use /services/landing/:route,
// the rest fall through to the existing ServiceDetail at /services/:slug
const landingRoutes = new Set(['web-development','full-stack','mobile-development','ui-ux','digital-marketing','ai-automation']);
      ...
      <PageHeroBanner className="bg-white py-6 sm:py-10">
        ...
        <div className="container-pad relative z-10">
          ...
          <m.h1
            ...
            transition={{ duration: 0.5, delay: 0.09, ease }}
          ...
          <m.p
            ...
            className="mt-4 max-w-xl text-base leading-relaxed text-gray-500"
          >
            Arkevion Technology brings strategy, design, development, automation, and digital growth
            together so businesses can launch better products and operate beyond limits.
          </m.p>
        </div>
      </PageHeroBanner>
        ...
        <div className="container-pad">
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {services.map(({ Icon, title, slug, body, color, image }, i) => {
              const href = landingRoutes.has(slug)
