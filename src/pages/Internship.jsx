...
import { Award, Bot, Code2, Layers, Palette, TrendingUp, Users, FolderKanban, ArrowRight, Briefcase, ChevronDown, X, CheckCircle2, Clock, Monitor, Sparkles, Send } from 'lucide-react';
...
const programs = [
  ...
  { Icon: Briefcase,  title: 'HR Management',          duration: '1–2 Months', mode: 'Online',           body: 'Recruitment, employee relations, HR tools, and workplace management.',         offerings: ['Recruitment & Talent Acquisition','Employee Onboarding processes','HR tools (HRMS, ATS)','Performance Management','Labour laws & compliance basics','Real HR operations exposure','Certificate & recommendation letter'] },
];
    ...
    <div className="w-full bg-white">
      ...
      <PageHeroBanner className="bg-white py-6 sm:py-10">
        ...
        <div className="container-pad relative z-10">
          <m.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease }}>
            <span className="eyebrow"><Sparkles size={11} /> Internship Programs</span>
          </m.div>
      ...
      <section className="py-6 sm:py-14">
        <div className="container-pad">
          <div className="flex items-center gap-2 mb-2">
            <span className="eyebrow"><Sparkles size={10} /> Available Programs</span>
          </div>
      ...
      <section className="py-6 sm:py-14 bg-[#fafcfc]">
        <div className="container-pad">
          <div className="text-center mb-10">
            <span className="eyebrow"><Sparkles size={10} /> What You Get</span>
          ...
          <div className="grid gap-3 sm:gap-4 grid-cols-2 sm:grid-cols-3">
            {[[Award, 'Certificate', 'Industry-recognised completion certificate for your portfolio and resume.'],
              ...
              <m.div key={title}
                variants={fadeUp} custom={i} initial="hidden" whileInView="visible" viewport={viewport}
                whileHover={{ y: -5 }}
                className="svc-card p-4 sm:p-7 text-center cursor-default"
                style={{ willChange: 'transform, opacity' }}
              >
      ...
      <section className="py-6 sm:py-14">
        <div className="container-pad grid gap-12 lg:grid-cols-2 lg:items-start">
          ...
          {/* Steps */}
          <div>
            <span className="eyebrow"><Sparkles size={10} /> How to Apply</span>
