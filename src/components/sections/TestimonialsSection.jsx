...
const testimonials = [
  { id: 1, name: 'Rahul Sharma', position: 'CEO',      company: 'TechVentures India', content: 'Arkevion delivered our platform ahead of schedule with exceptional quality. The end product exceeded every expectation. Their technical expertise and attention to detail truly set them apart.', rating: 5, avatar: 'https://api.dicebear.com/8.x/personas/svg?seed=RahulSharma&backgroundColor=0d9488' },
  { id: 2, name: 'Priya Nair',   position: 'Founder',  company: 'EduReach',           content: "The UI/UX redesign transformed our engagement metrics completely. Bounce rate dropped 40% within the first month. Our users consistently praise the new interface's intuitiveness.", rating: 5, avatar: 'https://api.dicebear.com/8.x/personas/svg?seed=PriyaNair&backgroundColor=0d9488' },
  { id: 3, name: 'Aditya Reddy', position: 'CTO',      company: 'FinanceFlow',        content: 'Top-notch full stack development. Seamless integrations and impressive performance optimization. The scalability of the solution has accommodated our rapid growth flawlessly.', rating: 5, avatar: 'https://api.dicebear.com/8.x/personas/svg?seed=AdityaReddy&backgroundColor=0d9488' },
  { id: 4, name: 'Vikram Singh', position: 'Director', company: 'LogiTrack',          content: 'The AI automation solution saved us 200+ hours of manual work every month. ROI was clear within weeks. Their innovative approach and commitment to excellence is remarkable.', rating: 5, avatar: 'https://api.dicebear.com/8.x/personas/svg?seed=VikramSingh&backgroundColor=0d9488' },
  { id: 5, name: 'Shafrin',      position: 'Intern - Full Stack Developer', company: 'Arkevion Technology', content: 'Interning at Arkevion was a transformative experience. I worked on real client projects from day one, sharpened my React and Node.js skills, and received mentorship that genuinely accelerated my growth as a developer.', rating: 5, avatar: 'https://api.dicebear.com/8.x/personas/svg?seed=Shafrin&backgroundColor=0d9488' },
  { id: 6, name: 'Shivasri',     position: 'Intern - Full Stack Developer', company: 'Arkevion Technology', content: 'The learning curve was steep in the best way possible. The team at Arkevion pushed me to think beyond textbooks. I left with a solid portfolio, a certificate, and confidence to take on any full stack challenge.', rating: 5, avatar: 'https://api.dicebear.com/8.x/personas/svg?seed=Shivasri&backgroundColor=0d9488' },
];
          ...
          <AnimatePresence mode="wait" custom={dir} initial={false}>
            ...
            >
              ...
              <div className="flex items-center justify-center gap-4">
                <div className="w-11 h-11 rounded-full overflow-hidden bg-gradient-to-br from-teal-500 to-teal-600 shrink-0">
